...
## My Contribution
I was responsible for all aspects of the project from start to finish. However, throughout my project, I received guidance from my mentor, who works as a Science Operations Specialist at DKIST. I also worked with a DKIST High-Level Software Engineer, who helped me produce the automated message queue system using Java. My project consisted of four main stages: 1) Research, 2) Feedback, 3) Prototyping and Integration, and 4) Message Automation.
...
The Java code can be accessed <a href="https://islandinvaders.github.io/">here.</a>
